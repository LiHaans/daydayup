...
public class MybatisPlusGenerator {
    public static void main(String[] args) {
        ...
        // 先得到当前工程目录
        String projectPath = System.getProperty("user.dir")+"\\security\\security-part2";
        ...
        dsc.setUrl("jdbc:mysql://36.111.28.104:3306/user_db?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
